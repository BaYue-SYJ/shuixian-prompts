# -*- coding: utf-8 -*-
"""v3：高召回人物判定 + 扫描模板 default 值 + 严格二次审计（铁律保证零泄漏）。
   有人(真人/动漫角色/模特/装饰/拟人/名字/姿态/服饰/职业/神明/特定角色) -> 人物(单一类)
   无人 -> 15 个非人主题之一
   铁律：最终落非人类的，若“严格人物审计”检出含人 -> 强制改回 人物
...
PERSON_DIRECT = [
    ...
    r"少女", r"少年", r"青年", r"成人", r"儿童", r"婴儿", r"宝宝", r"小孩", r"幼童", r"幼儿",
    r"老人", r"老年", r"老妪", r"中年", r"女子", r"男子", r"妇女", r"男士", r"女士",
    ...
    r"歌(?:手|星)", r"明星", r"名(?:人|模)", r"网红", r"博主", r"up主", r"运动员",
    ...
    r"纳税人", r"顾(?:客)?", r"婴孩", r"少年", r"主(?:人|顾)",
    # ---- 职业 / 角色 / 身份（扩充）----
    r"巫师", r"巫", r"术士", r"战(?:士|神)", r"守卫", r"守卫者", r"刺客", r"猎人", r"猎手",
    r"士兵", r"牧师", r"和尚", r"尼姑", r"天使", r"恶魔", r"魔鬼", r"妖怪", r"妖精", r"精灵",
    r"神灵", r"神明", r"神仙", r"罗汉", r"大帝", r"君主", r"首领", r"头领", r"反派", r"正派",
    r"英雄", r"主角", r"配角", r"路人", r"百姓", r"民众", r"平民", r"市民", r"居民", r"观众",
    r"游客", r"食客", r"酒客", r"舞者", r"歌者", r"乐手", r"琴师", r"画师", r"书生", r"仕女",
    r"壮士", r"侠女", r"刀客", r"盗贼", r"小偷", r"乞丐", r"农夫", r"渔夫", r"船夫", r"车夫",
    r"商贩", r"掌柜", r"店员", r"服务员", r"空姐", r"新手", r"老手", r"高手", r"专家", r"达人",
    r"玩家", r"受众", r"粉丝", r"摄影师", r"画家", r"设计师", r"作家", r"诗人", r"演员",
    r"侠", r"仕女", r"美人", r"壮士",
    # ---- 神明 / 神话角色（扩充）----
    r"观音", r"菩萨", r"哪吒", r"二郎神", r"如来", r"玉帝", r"王母", r"龙王", r"财神", r"灶神",
    r"土地公", r"太上老君", r"女娲", r"盘古", r"伏羲", r"神农", r"蚩尤", r"刑天", r"钟馗",
    r"牛头马面", r"孟婆", r"阎王", r"城隍", r"妈祖", r"关公", r"济公", r"八仙", r"妲己",
    r"白娘子", r"许仙", r"法海", r"牛郎", r"织女", r"精卫", r"夸父", r"后羿", r"嫦娥",
    # ---- 动漫 / 二次元 / 角色 ----
    ...
    r"Q版", r"chibi", r"吉祥物", r"cos服", r"兽耳", r"猫耳", r"狐耳", r"女仆", r"特摄",
    # ---- 姿态 / 服饰（强人物线索）----
    ...
    r"queen", r"king", r"prince", r"princess", r"goddess", r"god", r"deity", r"angel",
    r"demon", r"devil", r"elf", r"fairy", r"warrior", r"knight", r"paladin", r"wizard",
    r"warlock", r"witch", r"hunter", r"soldier", r"priest", r"monk", r"ninja", r"samurai",
    r"superhero", r"villain", r"hero", r"antagonist", r"mermaid", r"vampire", r"werewolf",
    r"zombie", r"ghost", r"spirit", r"being", r"guy", r"dude", r"fellow", r"peasant",
    r"merchant", r"archer", r"bard", r"rogue", r"mage", r"cleric", r"druid", r"barbarian",
    r"swordsman", r"fighter", r"commander", r"captain", r"general", r"officer", r"nurse",
    r"doctor", r"teacher", r"student", r"baby", r"kid", r"toddler", r"grandma", r"grandpa",
    r"mom", r"dad", r"headshot", r"head and shoulders", r"head turn", r"head pose",
    r"head shape", r"bust", r"full body", r"full-body",
    # ---- 特定人名/角色名（常见，扩充）----
    ...
    r"喜羊羊", r"哆啦A梦", r"路飞", r"鸣人", r"佐助", r"GigaChad",
]
...
PERSON_NAMEVERB = [
    ...
    r"[A-Za-z]{2,20}(?:'s selfie|'s portrait| is posing| posing| portrait| selfie| vs | versus | featuring | starring )",
    r"[A-Z][a-z]+ ?(?:vs|versus|VS|Versus) ?[A-Z][a-z]+",  # X vs Y 对抗角色
]

# ---- 扩充：职业/运动位置/动漫角色群/历史人物/名人/集换卡 ----
PERSON_EXTRA = [
    # 运动位置（中/英）
    r"前锋", r"后卫", r"中场", r"守门员", r"门将", r"球员", r"球星",
    r"forward", r"striker", r"midfielder", r"defender", r"goalkeeper", r"quarterback",
    r"pitcher", r"batter", r"sprinter", r"athlete", r"winger", r"fullback", r"linebacker",
    r"point guard", r"shooting guard", r"small forward", r"power forward", r"guard", r"中锋",
    # 职业（中/英，明确为人）
    r"宇航员", r"航天员", r"科学家", r"工程师", r"程序员", r"记者", r"律师", r"法官",
    r"总统", r"首相", r"市长", r"船长", r"将军", r"教授", r"牙医", r"厨师", r"农民",
    r"渔夫", r"工人", r"司机", r"飞行员", r"骑手", r"教皇", r"皇帝", r"皇后", r"少年",
    r"青年", r"先生", r"lord", r"lady", r"gentleman",
    r"astronaut", r"scientist", r"engineer", r"programmer", r"journalist", r"lawyer",
    r"judge", r"president", r"mayor", r"captain", r"general", r"professor", r"dentist",
    r"chef", r"farmer", r"fisherman", r"worker", r"driver", r"pilot", r"rider", r"pope",
    r"emperor", r"empress",
    # 人物活动（强线索）
    r"踢足球", r"踢球", r"打篮球", r"打板球", r"投篮", r"射门", r"挥杆", r"拥抱",
    r"微笑", r"唱歌", r"演奏", r"比心", r"跳舞", r"挥手", r"摆拍", r"街拍",
    # 照片/亲属/常见身份（补漏）
    r"毕业照", r"婚纱照", r"写真照", r"证件照", r"艺术照", r"肖像照", r"合照", r"合影",
    r"建筑师", r"建筑家", r"毕业生", r"校友", r"师生", r"学徒", r"师父", r"徒弟",
    r"邻居", r"村民", r"国民", r"公民", r"信徒", r"教徒", r"门徒", r"使徒", r"先知",
    r"圣人", r"贤人", r"志士", r"烈士", r"间谍", r"特工", r"乘客", r"球迷", r"顾客",
    r"食客", r"主角", r"配角", r"书生", r"仕女", r"美人", r"壮士", r"学者", r"文人",
    r"architect", r"footballer", r"player", r"graduate", r"classmate", r"passenger",
    # 动漫角色群
    r"圣斗士", r"圣斗士星矢", r"黄金圣斗士", r"星矢", r"龙珠", r"七龙珠", r"火影", r"火影忍者",
    r"海贼王", r"死神", r"妖精的尾巴", r"鬼灭之刃", r"炭治郎", r"柯南", r"名侦探柯南",
    r"宝可梦", r"皮卡丘", r"精灵宝可梦", r"数码宝贝", r"假面骑士", r"超级战队", r"美少女战士",
    r"灌篮高手", r"樱木花道", r"流川枫", r"网球王子", r"越前龙马", r"黑崎一护", r"漩涡鸣人",
    # 历史人物（中）
    r"荆轲", r"秦王", r"项羽", r"刘邦", r"韩信", r"岳飞", r"文天祥", r"林则徐", r"戚继光",
    r"郑和", r"张骞", r"苏武", r"屈原", r"司马迁", r"司马光", r"包拯", r"狄仁杰", r"宋慈",
    r"展昭", r"白玉堂",
    # 现代名人（英）
    r"David Bowie", r"Elon Musk", r"Trump", r"Obama", r"奥巴马", r"拜登",
]
PERSON_DIRECT_RE = re.compile("|".join(PERSON_DIRECT + PERSON_EXTRA), re.I)
...
def person_text(e):
    """拼接用于人物判定的全部文本：prompt + title + 模板 default 值。"""
    parts = []
    p = e.get("prompt", "") or ""
    t = e.get("title", "") or ""
    parts.append(p)
    parts.append(t)
    for m in DEFAULT_RE.findall(p):
        parts.append(m)
    return " ".join(parts).split()

def has_person(e):
    txt = " ".join(person_text(e))
    if PERSON_DIRECT_RE.search(txt):
        return True
    if PERSON_ANAT_RE.search(txt):
        return True
    if PERSON_NAMEVERB_RE.search(txt):
        return True
    return False
...
# =====================================================================
PERSON_STRICT_EXTRA = [
    r"古风", r"国风", r"汉风", r"唐风", r"和风", r"民族风",
    r"风韵", r"韵味的", r"端庄", r"温婉", r"妩媚", r"婉约", r"典雅女子", r"古典美人",
    r"肖像画", r"人像摄影", r"人物摄影", r"艺术人像", r"写真人像",
    r"眼波", r"眉眼", r"唇形", r"体态", r"身姿", r"仪态", r"风姿", r"特摄",
    r"Legends: Signature Series", r"trading card", r"collectible card", r"球星卡", r"明星卡",
]
PERSON_STRICT_RE = re.compile("|".join(PERSON_DIRECT + PERSON_EXTRA + PERSON_ANAT + PERSON_NAMEVERB + PERSON_STRICT_EXTRA), re.I)

def has_person_strict(e):
    txt = " ".join(person_text(e))
    return bool(PERSON_STRICT_RE.search(txt))
...
if __name__ == "__main__":
    ...
    overrides = {int(k): v for k, v in json.load(open(os.path.join(ROOT, "_person_overrides.json"), encoding="utf-8")).items()}
    ...
    for e in data:
        ...
        if i in manual:
            c = manual[i]
            if c != "人物" and has_person_strict(e):
    ...
    if manual_leak:
        print("⚠ 手动真值中疑似含人但归非人的条目（建议复核，不自动翻回）:")
    ...
    for cls in ["Logo/品牌/VI","海报/广告/社媒","产品/电商/包装","食物/饮品","UI/App/网页/SaaS","字体/排版/标题","插画/艺术/概念","3D/游戏/像素/等距","建筑/室内/空间","风景/自然","动物/宠物","车辆/机械/科幻","漫画/分镜/故事板","信息图/教育图解","抽象/纹理/背景","其他/未归类"]:
        samp = random.sample(byclass[cls], min(4, len(byclass[cls]))
        ) if byclass[cls] else []
        for e in samp:
            t = " ".join((e.get("prompt","") or e.get("title","")).split())[:100]
            print(f"  [{cls}] {e['id']}: {t}")
